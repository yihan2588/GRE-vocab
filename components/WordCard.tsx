...
type FullWord = Required<Pick<Word, 'id' | 'text' | 'definition' | 'exampleSentence'>>;
...
const WordCard: React.FC<WordCardProps> = ({
  ...
  isEvaluating = false,
  onMarkCorrect, // for old review
  onMarkIncorrect, // for old review
  onReveal, // for old review
  isReviewingPredefined = false, // for old review
  className = "",
